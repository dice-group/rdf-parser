...
TEST(TurtleOfficialNegativeTests, turtle_syntax_bad_base_02) {
    ...
    ASSERT_EQ(RdfStringParser::isParsable(
            "@BASE <http://www.w3.org/2013/TurtleTests/> ."),false);
...
TEST(TurtleOfficialNegativeTests, turtle_syntax_bad_esc_01) {
    ...
    ASSERT_EQ(RdfStringParser::isParsable(
            "<http://www.w3.org/2013/TurtleTests/s> <http://www.w3.org/2013/TurtleTests/p> \"a\\zb\" ."),false);
...
TEST(TurtleOfficialNegativeTests, DISABLED_turtle_syntax_bad_esc_02) {
    ...
    ASSERT_EQ(RdfStringParser::isParsable(
            "<http://www.w3.org/2013/TurtleTests/s> <http://www.w3.org/2013/TurtleTests/p> \"\\uWXYZ\" ."),false);
...
TEST(TurtleOfficialNegativeTests, DISABLED_turtle_syntax_bad_esc_03) {
    ...
    ASSERT_EQ(RdfStringParser::isParsable(
            "<http://www.w3.org/2013/TurtleTests/s> <http://www.w3.org/2013/TurtleTests/p> \"\\U0000WXYZ\" ."),false);
...
TEST(TurtleOfficialNegativeTests, turtle_syntax_bad_lang_01) {
    ...
    ASSERT_EQ(RdfStringParser::isParsable(
            "<http://www.w3.org/2013/TurtleTests/s> <http://www.w3.org/2013/TurtleTests/p> \"string\"@1 ."),false);
...
TEST(TurtleOfficialNegativeTests, turtle_syntax_bad_LITERAL2_with_langtag_and_datatype) {
    ...
    ASSERT_EQ(RdfStringParser::isParsable(
            "<http://example.org/resource> <http://example.org#pred> \"value\"@en^^<http://www.w3.org/1999/02/22-rdf-syntax-ns#XMLLiteral> ."),false);
...
TEST(TurtleOfficialNegativeTests, turtle_syntax_bad_num_01) {
    ...
    ASSERT_EQ(RdfStringParser::isParsable(
            "<http://www.w3.org/2013/TurtleTests/s> <http://www.w3.org/2013/TurtleTests/p> 123.abc ."),false);
...
TEST(TurtleOfficialNegativeTests, turtle_syntax_bad_num_02) {
    ...
    ASSERT_EQ(RdfStringParser::isParsable(
            "<http://www.w3.org/2013/TurtleTests/s> <http://www.w3.org/2013/TurtleTests/p> 123e ."),false);
...
TEST(TurtleOfficialNegativeTests, turtle_syntax_bad_num_03) {
    ...
    ASSERT_EQ(RdfStringParser::isParsable(
            "<http://www.w3.org/2013/TurtleTests/s> <http://www.w3.org/2013/TurtleTests/p> 123abc ."),false);
...
TEST(TurtleOfficialNegativeTests, turtle_syntax_bad_num_04) {
    ...
    ASSERT_EQ(RdfStringParser::isParsable(
            "<http://www.w3.org/2013/TurtleTests/s> <http://www.w3.org/2013/TurtleTests/p> 0x123 ."),false);
...
TEST(TurtleOfficialNegativeTests, turtle_syntax_bad_num_05) {
    ...
    ASSERT_EQ(RdfStringParser::isParsable(
            "<http://www.w3.org/2013/TurtleTests/s> <http://www.w3.org/2013/TurtleTests/p> +-1 ."),false);
...
TEST(TurtleOfficialNegativeTests, DISABLED_turtle_syntax_bad_prefix_01) {
    ...
    ASSERT_EQ(RdfStringParser::isParsable(
            ":s <http://www.w3.org/2013/TurtleTests/p> \"x\" ."),false);
...
TEST(TurtleOfficialNegativeTests, DISABLED_turtle_syntax_bad_prefix_02) {
    ...
    ASSERT_EQ(RdfStringParser::isParsable(
            ...
            "<http://www.w3.org/2013/TurtleTests/s> rdf:type :C ."),false);
...
TEST(TurtleOfficialNegativeTests, turtle_syntax_bad_prefix_04) {
    ...
    ASSERT_EQ(RdfStringParser::isParsable(
            "@prefix <http://www.w3.org/2013/TurtleTests/> ."),false);
...
TEST(TurtleOfficialNegativeTests, turtle_syntax_bad_prefix_05) {
    ...
    ASSERT_EQ(RdfStringParser::isParsable(
            "@prefix x <http://www.w3.org/2013/TurtleTests/> ."),false);
...
TEST(TurtleOfficialNegativeTests, turtle_syntax_bad_struct_01) {
    ...
    ASSERT_EQ(RdfStringParser::isParsable(
            "{ <http://www.w3.org/2013/TurtleTests/s> <http://www.w3.org/2013/TurtleTests/p> <http://www.w3.org/2013/TurtleTests/o> }"),false);
...
TEST(TurtleOfficialNegativeTests, turtle_syntax_bad_struct_02) {
    ...
    ASSERT_EQ(RdfStringParser::isParsable(
            "<http://www.w3.org/2013/TurtleTests/s> = <http://www.w3.org/2013/TurtleTests/o> ."),false);
...
TEST(TurtleOfficialNegativeTests, turtle_syntax_bad_struct_03) {
    ...
    ASSERT_EQ(RdfStringParser::isParsable(
            "<http://www.w3.org/2013/TurtleTests/s> <http://www.w3.org/2013/TurtleTests/p> <http://www.w3.org/2013/TurtleTests/o> <http://www.w3.org/2013/TurtleTests/g> ."),false);
...
TEST(TurtleOfficialNegativeTests, turtle_syntax_bad_struct_04) {
    ...
    ASSERT_EQ(RdfStringParser::isParsable(
            "\"hello\" <http://www.w3.org/2013/TurtleTests/p> <http://www.w3.org/2013/TurtleTests/o> ."),false);
...
TEST(TurtleOfficialNegativeTests, turtle_syntax_bad_struct_05) {
    ...
    ASSERT_EQ(RdfStringParser::isParsable(
            "<http://www.w3.org/2013/TurtleTests/s> \"hello\" <http://www.w3.org/2013/TurtleTests/o> ."),false);
...
TEST(TurtleOfficialNegativeTests, turtle_syntax_bad_struct_07) {
    ...
    ASSERT_EQ(RdfStringParser::isParsable(
            "<http://www.w3.org/2013/TurtleTests/s> _:p <http://www.w3.org/2013/TurtleTests/o> ."),false);
...
TEST(TurtleOfficialNegativeTests, turtle_syntax_bad_struct_10) {
    ...
    ASSERT_EQ(RdfStringParser::isParsable(
            ...
            "<http://www.w3.org/2013/TurtleTests/s1> <http://www.w3.org/2013/TurtleTests/p1> <http://www.w3.org/2013/TurtleTests/o1> ."),false);
...
TEST(TurtleOfficialNegativeTests, turtle_syntax_bad_struct_12) {
    ...
    ASSERT_EQ(RdfStringParser::isParsable(
            "<http://www.w3.org/2013/TurtleTests/s> <http://www.w3.org/2013/TurtleTests/p> "),false);
...
TEST(TurtleOfficialNegativeTests, turtle_syntax_bad_struct_14) {
    ...
    ASSERT_EQ(RdfStringParser::isParsable(
            "\"abc\" <http://www.w3.org/2013/TurtleTests/p> <http://www.w3.org/2013/TurtleTests/p>  ."),false);
...
TEST(TurtleOfficialNegativeTests, turtle_syntax_bad_struct_15) {
    ...
    ASSERT_EQ(RdfStringParser::isParsable(
            "<http://www.w3.org/2013/TurtleTests/s> \"abc\" <http://www.w3.org/2013/TurtleTests/p>  ."),false);
...
TEST(TurtleOfficialNegativeTests, turtle_syntax_bad_struct_17) {
    ...
    ASSERT_EQ(RdfStringParser::isParsable(
            "<http://www.w3.org/2013/TurtleTests/s> _:a <http://www.w3.org/2013/TurtleTests/p>  ."),false);
...
TEST(TurtleOfficialNegativeTests, turtle_syntax_bad_uri_01) {
    ...
    ASSERT_EQ(RdfStringParser::isParsable(
            "<http://www.w3.org/2013/TurtleTests/ space> <http://www.w3.org/2013/TurtleTests/p> <http://www.w3.org/2013/TurtleTests/o> ."),false);
...
TEST(TurtleOfficialNegativeTests, DISABLED_turtle_syntax_bad_uri_02) {
    ...
    ASSERT_EQ(RdfStringParser::isParsable(
            "<http://www.w3.org/2013/TurtleTests/\\u00ZZ11> <http://www.w3.org/2013/TurtleTests/p> <http://www.w3.org/2013/TurtleTests/o> ."),false);
...
TEST(TurtleOfficialNegativeTests, DISABLED_turtle_syntax_bad_uri_03) {
    ...
    ASSERT_EQ(RdfStringParser::isParsable(
            "<http://www.w3.org/2013/TurtleTests/\\U00ZZ1111> <http://www.w3.org/2013/TurtleTests/p> <http://www.w3.org/2013/TurtleTests/o> ."),false);
...
TEST(TurtleOfficialNegativeTests, turtle_syntax_bad_uri_04) {
    ...
    ASSERT_EQ(RdfStringParser::isParsable(
            "<http://www.w3.org/2013/TurtleTests/\\n> <http://www.w3.org/2013/TurtleTests/p> <http://www.w3.org/2013/TurtleTests/o> ."),false);
...
TEST(TurtleOfficialNegativeTests, turtle_syntax_bad_uri_05) {
    ...
    ASSERT_EQ(RdfStringParser::isParsable(
            "<http://www.w3.org/2013/TurtleTests/\\/> <http://www.w3.org/2013/TurtleTests/p> <http://www.w3.org/2013/TurtleTests/o> ."),false);
