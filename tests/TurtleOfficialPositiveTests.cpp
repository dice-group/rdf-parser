...
TEST(TurtleOfficialPositiveTests, turtle_syntax_str_esc_01) {
   ...
   TurtleParser<StringParser> parser("<http://www.w3.org/2013/TurtleTests/s> <http://www.w3.org/2013/TurtleTests/p> \"a\\n\" .");
   parser.begin();
}
...
TEST(TurtleOfficialPositiveTests, turtle_syntax_string_01) {
   ...
   TurtleParser<StringParser> parser("<http://www.w3.org/2013/TurtleTests/s> <http://www.w3.org/2013/TurtleTests/p> \"string\" .");
   parser.begin();
}
...
TEST(TurtleOfficialPositiveTests, turtle_syntax_string_08) {
   ...
   TurtleParser<StringParser> parser("<http://www.w3.org/2013/TurtleTests/s> <http://www.w3.org/2013/TurtleTests/p> \"\"\"abc\n"
                          "def\"\"\" .");
   parser.begin();
}
