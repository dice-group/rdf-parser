...
TEST(TurtleOfficalExamplesTests, EXAMPLE1) {
    TurtleParser<false,StringParser<>> parser("@base <http://example.org/> .\n"
...
TEST(TurtleOfficalExamplesTests, EXAMPLE2) {
   ...
   TurtleParser<false,StringParser<>> parser(
...
TEST(TurtleOfficalExamplesTests, EXAMPLE6) {
   ...
   TurtleParser<false,StringParser<>> parser("<http://example.org/#spiderman> <http://xmlns.com/foaf/0.1/name> \"Spiderman\" .\n"
...
TEST(TurtleOfficalExamplesTests, EXAMPLE7) {
   ...
   TurtleParser<false,StringParser<>> parser("@prefix somePrefix: <http://www.perceive.net/schemas/relationship/> .\n"
                          "\n"
...
TEST(TurtleOfficalExamplesTests, EXAMPLE10) {
   ...
   TurtleParser<false,StringParser<>> parser("@prefix foaf: <http://xmlns.com/foaf/0.1/> .\n"
                          "\n"
...
TEST(TurtleOfficalExamplesTests, EXAMPLE11) {
   ...
   TurtleParser<false,StringParser<>> parser("@prefix show: <http://example.org/vocab/show/> .\n"
...
TEST(TurtleOfficalExamplesTests, EXAMPLE13) {
   ...
   TurtleParser<false,StringParser<>> parser("@prefix : <http://example.org/stats> .\n"
...
TEST(TurtleOfficalExamplesTests, EXAMPLE17) {
   ...
   TurtleParser<false,StringParser<>> parser("_:a <http://xmlns.com/foaf/0.1/name> \"Alice\" .\n"
...
TEST(TurtleOfficalExamplesTests, EXAMPLE18) {
   ...
   TurtleParser<false,StringParser<>> parser("@prefix : <http://example.org/foo> .\n"
...
TEST(TurtleOfficalExamplesTests, EXAMPLE19) {
   ...
   TurtleParser<false,StringParser<>> parser("@prefix rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#> .\n"
...
TEST(TurtleOfficalExamplesTests, EXAMPLE21) {
   ...
   TurtleParser<false,StringParser<>> parser("@prefix : <http://example.org/stuff/1.0/> .\n"
                          "@prefix rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#> .\n"
                          ":a :b\n"
                          "  [ rdf:first \"apple\";\n"
