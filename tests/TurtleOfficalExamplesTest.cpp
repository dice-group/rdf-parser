...
TEST(TurtleOfficalExamplesTests, EXAMPLE1) {
    rdf_parser::Turtle::StringParser<> parser("@base <http://example.org/> .\n"
...
TEST(TurtleOfficalExamplesTests, EXAMPLE2) {
   ...
   rdf_parser::Turtle::StringParser<> parser(
...
TEST(TurtleOfficalExamplesTests, EXAMPLE6) {
   ...
   rdf_parser::Turtle::StringParser<> parser("<http://example.org/#spiderman> <http://xmlns.com/foaf/0.1/name> \"Spiderman\" .\n"
...
TEST(TurtleOfficalExamplesTests, EXAMPLE7) {
   ...
   rdf_parser::Turtle::StringParser<> parser("@prefix somePrefix: <http://www.perceive.net/schemas/relationship/> .\n"
                          "\n"
...
TEST(TurtleOfficalExamplesTests, EXAMPLE10) {
   ...
   rdf_parser::Turtle::StringParser<> parser("@prefix foaf: <http://xmlns.com/foaf/0.1/> .\n"
                          "\n"
...
TEST(TurtleOfficalExamplesTests, EXAMPLE11) {
   ...
   rdf_parser::Turtle::StringParser<> parser("@prefix show: <http://example.org/vocab/show/> .\n"
...
TEST(TurtleOfficalExamplesTests, EXAMPLE13) {
   ...
   rdf_parser::Turtle::StringParser<> parser("@prefix : <http://example.org/stats> .\n"
...
TEST(TurtleOfficalExamplesTests, EXAMPLE17) {
   ...
   rdf_parser::Turtle::StringParser<> parser("_:a <http://xmlns.com/foaf/0.1/name> \"Alice\" .\n"
...
TEST(TurtleOfficalExamplesTests, EXAMPLE18) {
   ...
   rdf_parser::Turtle::StringParser<> parser("@prefix : <http://example.org/foo> .\n"
...
TEST(TurtleOfficalExamplesTests, EXAMPLE19) {
   ...
   rdf_parser::Turtle::StringParser<> parser("@prefix rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#> .\n"
...
TEST(TurtleOfficalExamplesTests, EXAMPLE21) {
   ...
   rdf_parser::Turtle::StringParser<> parser("@prefix : <http://example.org/stuff/1.0/> .\n"
                          "@prefix rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#> .\n"
                          ":a :b\n"
                          "  [ rdf:first \"apple\";\n"
